  ...
  class SEQ_Settings
  {
    ...
    { ?>
      <div style="display:flex;align-items:center;">
        <input type="range" id="seq_discount" name="seq_options[seq_discount]" min="0" max="100" step="1" value="<?php echo isset(self::$options['seq_discount']) ? esc_attr(self::$options['seq_discount']) : '25'; ?>">
    ...
    { ?>
      <textarea name="seq_options[seq_resposta_positiva]" id="seq_resposta_positiva" cols="80" rows="4"><?php echo isset(self::$options['seq_resposta_positiva']) ? esc_textarea(self::$options['seq_resposta_positiva']) : ''; ?></textarea>
    <?php
    }
    ...
    { ?>
      <textarea name="seq_options[seq_resposta_negativa]" id="seq_resposta_negativa" cols="80" rows="4"><?php echo isset(self::$options['seq_resposta_negativa']) ? esc_textarea(self::$options['seq_resposta_negativa']) : ''; ?></textarea>
